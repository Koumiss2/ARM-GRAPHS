...
struct qt_meta_stringdata_CLASSScoreENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSScoreENDCLASS = QtMocHelpers::stringData(
    "Score",
    "slot1",
    "",
    "a",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSScoreENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Score::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSScoreENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSScoreENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSScoreENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void Score::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->slot1((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
...
void *Score::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSScoreENDCLASS.stringdata0))
